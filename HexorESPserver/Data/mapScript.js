document.addEventListener("DOMContentLoaded", function () {
    ...
    let drawPathIdx = 0;
    let Goal, rect, mPos, mZ;
    let runningOnServer = false;
    let pixelSize = 1;
    let pixelsInCm = 20;//1px is 20cm
    ...
    let maxVectorLen = 0;
    let tim; //time inteval to draw map changes of client actions
    
    //let direction = ["SE","ES"]; //SE = start to end, ES = end to start
    let pathDirection = "SE";

    //target position in native map coordinates (not affected by zoom or shift of map in canvas)
    var Target = { x: 0, y: 0, size: 1, en: false, valid: true, change: true, scaling: { H: 1, W: 1 } };
    var Robot =  { x: 0, y: 0, size: 2, en: false, valid: true, change: true, scaling: { H: 1, W: 1 } };
    var mapModes = ["move", "select", "info", "drawObject"], lastMapMode;
    let point = []; //definition of insides: { x: -1, y: -1, importance: -1};
    //let pointDataSize = 3;
    let path = [];
    //let pathLength;
    //let xiPositionVal = -3, yiPositionVal = -2, iPointVal = -1;
    let v = 0;
    ...
    //let tempStartScrollX = 2, tempStartScrollY = 2;
    var mapMode = mapModes[0];

    const mapImage = new Image();
    //mapImage.crossOrigin = "same-origin";
    let mapImageH, mapImageW;
    mapImage.src = "map3me.bmp";
    let mapStringArray = "";
    let img;
    ...
    let scaleW = 1, scaleH = 1, scale = 1;

    //EVENTS ---------------------------------------------------------------------------------------------------------------------

    mapImage.onload = () => {
        //still loading an image, call this form somwhere where no image is loaded? ... 
        mapEnvSet();
    };
    ...
    canvas.addEventListener("mousedown", (e) => {
        ...
        if (mapMode == mapModes[0]) {
            ...
            locY2 = Math.floor((locY - startScrollY) / scaleH, 1);
            if (e.button == mouseBtns.left && !e.ctrlKey) {
    ...
    document.addEventListener("mousemove", (e) => {        
        ...
        if ((startScrollX + mapImage.width * scaleW) < 0 || startScrollX > canvas.clientWidth) {
            startScrollX = 2;
        }
        if ((startScrollY + mapImage.height * scaleH) < 0 || startScrollY > canvas.clientHeight) {
            startScrollY = 2;
        }
    });
    ...
    canvas.addEventListener("wheel", (e) => {
        ...
        if ((startScrollX + mapImage.width * scaleW) < 0 || (startScrollX > canvas.clientWidth/2)) {
            startScrollX = 2;
        }
        if ((startScrollY + mapImage.height * scaleH) < 0 || (startScrollY > canvas.clientHeight/2)) {
            startScrollY = 2;
        }
        draw();   
    ...
    function draw() {
        ...
        if (Target.en && Robot.en && Robot.valid && Target.valid) {
            if ((Target.change || Robot.change) && Robot.valid && Target.valid) {
                ...
                let res, res1;
                try {
                    res = generatePath([Robot.x, Robot.y, 0], [Target.x, Target.y, 0]) //AP, GP, len, limit;
                }
                catch (err) {
                ...
                try {
                    res1 = generatePath([Target.x, Target.y, 0], [Robot.x, Robot.y, 0]);
                }
                catch (err) {
                    console.log(err.message);
                    res1[0] = -1;
    ...
    function generatePath(AP, GP) { //v2.0
